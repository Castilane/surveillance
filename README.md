...
🚀 初始化干净的 Session...
🌐 [1/4] 访问签到链接，触发重定向...
   -> 截获当前 Cookie 凭证: {'JSESSIONID': 'FB9....3B.oauth114', 'canvas_sjtu_session': '....%3D'}
🔍 [2/4] 获取验证码 (UUID: 0e2d8869...)...
🤖 AI 识别结果: [xeyv] (已清理幽灵字符)
⏳ 伪装人类手速，停顿 1 秒以防触发 WAF 风控拦截...
🔥 [3/4] 提交核心数据...
   -> 服务器底牌: {'errno': 0, 'error': None, 'code': None, 'url': '/jaccount/jalogin?sid=jaoauth2201607......osMsMdU4sLvrc5CuQqsjnxg9OgY'}
✅ [4/4] 登录成功！服务器已放行。
